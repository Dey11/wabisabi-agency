  ...
  return (
    <div className="grid h-[85dvh] grid-cols-20 gap-6">
      <div className="col-span-10 flex flex-col justify-between pt-10">
        ...
        <p>
          With over 4 years of experience, our agency has grown into a trusted
      ...
      <div className="relative col-span-10 flex justify-end overflow-hidden pt-10">
        <Image
          src="/rudrakshpic.jpg"
          alt="rudraksh"
          width={380}
          height={200}
          priority
          className="absolute -bottom-1/4 rounded-t-3xl object-cover shadow-2xl drop-shadow-lg"
        />
      </div>
    </div>
  );
